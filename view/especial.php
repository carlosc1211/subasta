...
$regular = "SELECT id, name, description, startDate, endDate, price, deposit FROM especial WHERE id = $id;";
  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="form-group">
            ...
            <input disabled type="email" class="form-control" value="<?php echo $deposit; ?>">
        </div>
    </div>

    <div class="container">
        <div class="form-group">
            <form action="../controllers/insertEspecial.php" method="POST">
                <label for="exampleInputEmail1">Inserte su puja</label>
                <input type="text" hidden name="tipo" value="<?php echo "Especial"; ?>">
                <input type="text" hidden name="description" value="<?php echo $description; ?>">
                <input type="number" hidden name="idSubasta" value="<?php echo $id; ?>">
